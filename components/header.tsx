      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between p-4 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Prime Smart</span>
            <Image src="/images/logo.png" alt="Prime Smart" width={150} height={50} className="h-10 w-auto" />
          </Link>
        </div>
      ...
      <div className={cn("lg:hidden", mobileMenuOpen ? "fixed inset-0 z-50" : "hidden")}>
        ...
        <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <Link href="/" className="-m-1.5 p-1.5">
              <span className="sr-only">Prime Smart</span>
              <Image src="/images/logo.png" alt="Prime Smart" width={150} height={50} className="h-8 w-auto" />
            </Link>
